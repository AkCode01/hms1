...
include("incl/functions.php");
 ...
 // print_r($_POST);
if(!isset($_POST['LabTestSubTypeID'])){
    header("location:index.php");
}

$LTSTID = $_POST['LabTestSubTypeID'];
...
$LabTestSubType = Get_Lab_Test_Sub_Type_ByID($LTSTID);
// print_r($LabTestTYpes);
?>
<!doctype html>
<html>
<head>
...
<div class="row mb-1">
        <div class="col-md-6">
        <h5>Update Lab Test Sub Type</h5>
        </div>
        <div class="col-md-6 text-start text-md-end">
            <a class="btn btn-primary btn-sm mb-2" href="lab_test_sub_type.php">View All</a>
        </div>  
    </div>
<div class="row">
...
<div class="col-md-4">
    <label for="LTSTID" class="form-label">Sub Type ID</label>
    <input type="number" name="LTSTID" value="<?php echo $LabTestSubType[0]['lab_test_sub_type_id'] ?>" class="form-control form-control-sm" readonly>
</div> 
<div class="col-md-4">  
<label for="TypeID" class="form-label">Lab Test Type</label>
    <select class="form-control form-select form-select-sm" required name="TypeID">
        ...
        <option value="<?php echo $LabTestTYpe['lab_test_type_id']; ?>" <?php if($LabTestTYpe['lab_test_type_id']==$LabTestSubType[0]['lab_test_type_id']){echo "selected";}?>>
...
<div class="col-md-4">
    <label for="SubTypeName" class="form-label">Type Name</label>
    <input type="text" name="SubTypeName" value="<?php echo $LabTestSubType[0]['lab_test_sub_type_name'] ?>" class="form-control form-control-sm">
</div> 
...
<div class="col-md-4">
    <label for="status" class="form-label">Status</label>
        <select class="form-control form-select form-select-sm" name="status" required>
            ...
            <?php if($LabTestSubType[0]['lab_test_sub_type_status']== 1){ ?>
        ...
        <div class="mt-3">
            <input type="submit" name="EditLabTestSubType" value="Save Changes" class="btn btn-primary btn-sm">
        </div>
    </div>
</form>
