...
<form action="SaveData.php" method="post" enctype="multipart/form-data">
    <div class="p-2">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-4">
                <label for="hcode" class="form-label">Hospital Code</label>
                <input type="text" class="form-control form-control-sm" name="hcode" required>
            </div>
            <div class="col-md-4">
                <label for="haddress" class="form-label">Address</label>
                <input type="text" class="form-control form-control-sm " name="haddress">
            </div>
            <div class="col-md-4">
                <label for="hcontact" class="form-label">Contact</label>
                <input type="text" class="form-control form-control-sm " name="hcontact">
            </div>
            <div class="col-md-4">
                <label for="hemail" class="form-label">Email</label>
                <input type="text" class="form-control form-control-sm " name="hemail">
            </div>
            <div class="col-md-4">
                <label for="hwebsite" class="form-label">Website</label>
                <input type="text" class="form-control form-control-sm " name="hwebsite">
        ...
        <div class="mt-3">
            <input type="submit" name="AddHospital" value="Save" class="btn btn-primary btn-sm">
        </div>
    </div>
</form>
</div>
