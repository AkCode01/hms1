...
<form action="SaveNewData.php" method="post" enctype="multipart/form-data">
    <div class="p-2">
        <div class="row g-3 align-items-center">
            <div class="col-md-4">
                <label for="POASSID" class="form-label">Pre OP Asses Id</label>
                <input type="text" name="POASSID" value="<?php echo $posassid ?>" class="form-control form-control-sm" readonly>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
            <label for="PrePoAssesImage" class="form-label">Image</label>
                <input type="file" id="PrePoAssesImage" name="PrePoAssesImage[]" multiple accept="image/png, image/jpg, image/jpeg" class="form-control form-control-sm">    
            ...
            <div class="col-md-4">
                <br>
                <input type="submit" name="AddPreOpAssesmentMedia" value="Save" class="btn btn-primary btn-sm">
            </div>
            <div class="col-md-4">
                <br>
