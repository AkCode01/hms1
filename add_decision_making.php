    ...
    <div class="p-2">
        <div class="row g-3 align-items-center">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm"  name="medication">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm"  name="instructions">
        ...
        <div class="mt-3">
            <input type="submit" name="AddDecisionMaking" value="Save" class="btn btn-primary btn-sm">
